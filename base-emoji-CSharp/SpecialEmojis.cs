...
public static class SpecialEmojis
{
    public class ArmorClass
    {
        internal Rune _marker;
        internal Rune _beginChar;
        internal Rune _endChar;
        internal Rune _descriptor;
        public Rune Marker
        {
            get
            {
    ...
    public static Rune[] Padding { get; }
    public static ArmorClass Armor { get; }

    public static Rune[] Emojis;

    static SpecialEmojis()
    {
        var rawRunes = new[] {
            "😀", "😃", "😄", "😁", "😆", "😅", "🤣", "😂", "🙂",
            "🙃", "😉", "😊", "😇", "🥰", "😍", "🤩", "😘", "😗", "😚", "😙", "🥲", "😋",
